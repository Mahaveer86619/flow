...
class _SplashScreenState extends State<SplashScreen>
  ...
  void _maybeNavigate() {
    if (_animationDone && _authCheckDone && mounted) {
  ...
  void didChangeDependencies() {
    ...
    // If auth check already finished before the BlocListener attached, mark done.
    final authState = context.read<AuthCubit>().state;
    if (!authState.isChecking && !_authCheckDone) {
      _authCheckDone = true;
      _maybeNavigate();
    }
  }
  ...
  Widget build(BuildContext context) {
    return BlocListener<AuthCubit, AuthState>(
      listenWhen: (prev, curr) => prev.isChecking && !curr.isChecking,
