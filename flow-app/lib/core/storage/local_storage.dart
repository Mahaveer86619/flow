...
class LocalStorage {
  ...
  /// Last known authentication state from the server.
  /// Updated by [AuthCubit] on every app start and after login/logout.
  bool get isAuthenticated =>
      (_auth.get(HiveKeys.isAuthenticated) as bool?) ?? false;

  void saveIsAuthenticated(bool value) {
    _auth.put(HiveKeys.isAuthenticated, value);
    AppLogger.d('LocalStorage', 'Auth state persisted: $value');
  }
}
