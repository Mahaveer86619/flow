      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: GoogleFonts.outfit(color: colorScheme.outline, fontSize: 15),
          ),
          const SizedBox(height: 48),
        ],
      ),
...
class _RecentlyPlayedSheet extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    // BlocProvider.value passed from parent ensures this sheet has access to
    // PlayerCubit even though it's in a new route context (showModalBottomSheet)
