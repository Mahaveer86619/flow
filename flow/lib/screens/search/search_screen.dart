...
//
// Search history is stored in [SearchCubit.state.recentSearches] (in-memory).
// To persist across sessions, save/load the list from SharedPreferences inside
// [SearchCubit].
// ─────────────────────────────────────────────────────────────────────────────
...
class _SearchScreenState extends State<SearchScreen> {
  ...
  void initState() {
    super.initState();
    // Track focus to show/hide the recent-searches list.
        ...
        SliverToBoxAdapter(
          child: Padding(
            ...
            child: SearchBar(
              ...
              // Save to history when the user submits (keyboard "done").
              onSubmitted: (v) {
                if (v.isNotEmpty) {
