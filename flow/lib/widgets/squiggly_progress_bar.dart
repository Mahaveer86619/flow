    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        return GestureDetector(
          ...
          onHorizontalDragUpdate: (d) => _handleSeek(d.localPosition, constraints),
...
class _SquigglyPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    if (progress > 0) {
      ...
      // Outer dot
      canvas.drawCircle(Offset(progressX, dotY), 4, Paint()..color = playedColor);
      // Inner white dot
      canvas.drawCircle(Offset(progressX, dotY), 2, Paint()..color = Colors.white);
    }
  }
